package com.example.signupandsignin.Adapter
...
class RecyclerViewAdapter( private var userList: ArrayList<Users>): RecyclerView.Adapter<RecyclerViewAdapter.ItemViewHolder>()  {
